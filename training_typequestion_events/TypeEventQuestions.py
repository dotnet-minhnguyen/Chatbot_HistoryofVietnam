...
data_typequestion = pickle.load(
    open("./training_typequestion_events/training_data", "rb"))
...
model_typequestion = tflearn.DNN(
    net_typequestion, tensorboard_dir='./training_typequestion_events/tflearn_logs')
# ------------------ END TYPE QUESTION ---------------------

model_typequestion.load('./training_typequestion_events/model.tflearn')

ERROR_THRESHOLD_ = 0.5

def typeEventQuestion(sentence):
