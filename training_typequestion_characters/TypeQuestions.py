...
data_typequestion = pickle.load(
    open("./training_typequestion_characters/training_data", "rb"))
...
model_typequestion = tflearn.DNN(
    net_typequestion, tensorboard_dir='./training_typequestion_characters/tflearn_logs')
# ------------------ END TYPE QUESTION ---------------------

model_typequestion.load('./training_typequestion_characters/model.tflearn')
